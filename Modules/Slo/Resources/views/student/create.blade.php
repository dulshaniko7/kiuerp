                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-control col-lg-12" required="required" name="title" id="select"
                                            style="width:144px">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class=" input-group mb-3">
                                    ...
                                    <textarea class="form-control" name="given_name[]" placeholder="Full Name"
                                ...
                                <div class=" input-group mb-3">
                                    ...
                                    <input type="text" class="form-control nic-pass" id="nicpass" name="nic_no[]"
                                ...
                                <div class=" input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" required="required" id="select-payment-plan"
                                           name="payment_plan[]">
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control mobile" name="mobile[]" value="0"
